---
{"dg-publish":true,"permalink":"/los-huerfanos-del-sol/01-sistema-y-reglas-de-la-casa/el-sistema-de-entereza/","dg-note-properties":{}}
---
...
$$\text{Puntos Máximos} = 10 + \text{Modificador de Constitución} + \text{Modificador de Sabiduría} + \text{Bonus de Competencia}$$
...
- **CD 10 – Entorno Protegido:** Viajar por un Camino de Sal balizado en superficie durante un período de Calma Ciega.
    
- **CD 12 – Túneles Subterráneos Abandonados:** Explorar conductos colapsados, alcantarillas del Viejo Mundo o túneles de servicio sin mantenimiento térmico, expuestos a corrientes heladas y claustrofobia.
    
- **CD 13 – El Yermo Abierto:** Viajar Campo a Través durante un período de Calma Ciega, o estar guarecido en un Caparazón de superficie sin fuentes de calor activas.
    
- **CD 15 – Exposición Extrema:** Viajar en Marcha Veloz (aplica Desventaja a la tirada), adentrarse en zonas de ceniza densa o transitar durante el inicio de El Rugido.
...
- **11 Puntos o más – Estado Estable:** Sin penalizadores. El personaje mantiene el calor metabólico y la mente enfocada.
...
### Templanza (Entereza):
- Utilizada para resistir el pánico, ignorar las alucinaciones del yermo o evitar la locura temporal al presenciar aberraciones o ferales.
    
### Aclimatación (Entereza):
- Se usa para realizar sobreesfuerzos físicos bajo el frío extremo, como desenterrar a un aliado atrapado en la ceniza a contrarreloj o resistir daño por congelación directa.
    
### Entereza Mental (Entereza):
...
### Sangre de Búnker:
Te creaste cerca de los reactores geotérmicos. Tus puntos máximos de Entereza aumentan en un valor igual a tu **Bonus de Competencia** y cuando realizas una Marcha Rompevientos en cordada todo el grupo tiene  +1 en tiradas de entereza.
### Metabolismo glaciar:
Tu cuerpo ha aprendido a economizar energía de forma extrema bajo temperaturas de congelación. Consumes la mitad de raciones de comida en el exterior y, cuando el grupo sufre un _Golpe de Frío Anómalo_ o un _Vórtice de Ceniza_ debido al sumatorio de fallos del d100, tú eres inmune a la pérdida de esos puntos de Entereza adicionales.
...
- **En el Exterior / Túneles Hostiles:** Está totalmente prohibido realizar descansos largos. Intentarlo equivale a morir congelado en pocas horas.
    
- **En el Subsuelo Seguro (Búnkeres y Enclaves):** Al completar un Descanso Largo (8 horas) al amparo de calor geotérmico real, el personaje **no recupera el total**. En su lugar, restablece:
